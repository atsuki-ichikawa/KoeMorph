...
class TestEmotion2VecExtractor:
    ...
    def test_forward_shape_single_sample(self):
        ...
        extractor = Emotion2VecExtractor(
            model_name="dummy", target_fps=30, output_dim=256
        )
    ...
    def test_forward_shape_batch(self):
        ...
        extractor = Emotion2VecExtractor(
            model_name="dummy", target_fps=25, output_dim=128
        )
    ...
    def test_different_pooling_methods(self):
        ...
        for method in pooling_methods:
            extractor = Emotion2VecExtractor(
                model_name="dummy", pooling_method=method, target_fps=20, output_dim=64
            )
    ...
    def test_layer_fusion(self):
        ...
        extractor = Emotion2VecExtractor(
            model_name="dummy", layer_weights=layer_weights, output_dim=128
        )
    ...
    def test_freeze_pretrained(self):
        ...
        extractor = Emotion2VecExtractor(model_name="dummy", freeze_pretrained=True)
