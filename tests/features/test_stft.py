...
class TestMelSpectrogramExtractor:
    ...
    def test_invalid_parameters(self):
        ...
        with pytest.raises(ValueError):
            MelSpectrogramExtractor(sample_rate=100, target_fps=200)  # hop_length would be 0
...
class TestInverseMelSpectrogram:
    ...
    def test_reconstruction_basic(self, mel_extractor):
        ...
        inverse = InverseMelSpectrogram(mel_extractor, n_iter=8)  # Fewer iterations for speed
...
class TestParameterValidation:
    ...
    def test_nfft_hop_mismatch(self):
        ...
        results = validate_mel_parameters(
            sample_rate=16000,
            target_fps=10.0,  # Large hop_length
            n_fft=512,
            n_mels=80
        )
