...
class TestKoeMorphLoss:
    ...
    def test_metrics_computation(self):
        ...
        expected_metrics = ['mae', 'rmse', 'correlation', 'precision', 'recall', 'f1_score']
...
class TestPerceptualBlendshapeLoss:
    ...
    def test_audiovisual_consistency(self):
        ...
        blendshapes[:, perceptual_loss.mouth_group] = torch.rand(batch_size, len(perceptual_loss.mouth_group))
...
class TestBlendshapeMetrics:
    ...
    def test_metrics_update_and_compute(self):
        ...
        expected_metrics = ['mae', 'mse', 'rmse', 'max_bs_mae', 'min_bs_mae', 
                           'mean_correlation', 'precision', 'recall', 'f1_score']
